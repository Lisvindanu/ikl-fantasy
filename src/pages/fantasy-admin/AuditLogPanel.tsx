    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-gray-600 font-bold">Page {page + 1}</span>
          <button
            ...
            <table className="w-full text-sm min-w-[500px]">
              <thead>
                <tr style={{ background: 'rgba(255,255,255,0.03)' }}>
                  <th className="text-left px-3 py-2.5 text-gray-500 font-bold text-xs">Time</th>
                  <th className="text-left px-3 py-2.5 text-gray-500 font-bold text-xs">Admin</th>
                  <th className="text-left px-3 py-2.5 text-gray-500 font-bold text-xs">Action</th>
                  <th className="text-left px-3 py-2.5 text-gray-500 font-bold text-xs">Target</th>
                </tr>
              </thead>
              <tbody>
                {entries.map(entry => (
