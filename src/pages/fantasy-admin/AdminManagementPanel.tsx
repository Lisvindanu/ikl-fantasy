      ...
      <div className="p-5 space-y-4">
        ...
        <form onSubmit={handleSearch} className="flex gap-2">
          ...
          <button type="submit" disabled={searching}
            className="px-4 py-2.5 rounded-xl text-xs font-bold text-black disabled:opacity-60 transition-opacity"
          ...
          <div className="flex items-center gap-3 px-3.5 py-2.5 rounded-xl"
            ...
            {foundUser.is_admin ? (
              ...
              <button onClick={() => handleGrant(foundUser.id)}
                className="text-xs font-bold px-3.5 py-1.5 rounded-xl text-black transition-opacity"
                style={{ background: 'linear-gradient(135deg,#FBBF24,#F59E0B)' }}>
                Grant Admin
              </button>
            )}
